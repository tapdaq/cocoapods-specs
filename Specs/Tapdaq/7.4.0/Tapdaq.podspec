Pod::Spec.new do |s|
  ...
  s.platform     = :ios, "9.0"
  s.source       = { :http => "http://ios-sdk.tapdaq.com/7.4.0/cocoapods_frameworks.zip" }
  ...
  s.subspec "AdColony" do |adcolony|
    ...
    adcolony.dependency "AdColony", "4.1.2"
  end
  ...
  s.subspec "AdMob" do |admob|
    ...
    admob.dependency "Google-Mobile-Ads-SDK", "7.51.0"
  end
  ...
  s.subspec "AppLovin" do |applovin|
    ...
    applovin.dependency "AppLovinSDK", "6.9.5"
  end
  ...
  s.subspec "FAN" do |fan|
    ...
    fan.dependency "FBAudienceNetwork", "5.6.0"
  end
  ...
  s.subspec "InMobi" do |inmobi|
    ...
    inmobi.dependency "InMobiSDK", "9.0.0"
  end
  ...
  s.subspec "IronSource" do |ironsource|
    ...
    ironsource.dependency "IronSourceSDK", "6.8.7"
  end
  ...
  s.subspec "Mintegral" do |mintegral|
    ...
    mintegral.dependency "MintegralAdSDK", "5.8.1"
  ...
  s.subspec "TikTok" do |tiktok|
    ...
    tiktok.dependency "Bytedance-UnionAD", "2.4.6.7"
  end
  ...
  s.subspec "UnityAds" do |unityads|
    ...
    unityads.dependency "UnityAds", "3.3.0"
  end
  ...
  s.subspec "Vungle" do |vungle|
    ...
    vungle.dependency "VungleSDK-iOS", "6.4.5"
  end
  ...
  s.subspec "YouAppi" do |youappi|
    ...
    youappi.dependency "YouAppiMoatSDK", "4.4.4"
  end
