Pod::Spec.new do |s|
  ...
  s.platform     = :ios, "9.0"
  s.source       = { :http => "https://s3.eu-west-2.amazonaws.com/tapdaq-ios-sdk/release/#{s.version}/#{s.version}/cocoapods_frameworks.zip" }
  ...
  s.subspec "HyprMx" do |hyprmx|
    ...
    hyprmx.dependency "TapdaqHyprMXSDK", "7.1.90"
  end
