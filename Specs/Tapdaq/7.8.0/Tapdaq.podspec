Pod::Spec.new do |s|
  ...
  s.platform     = :ios, "9.0"
  s.source       = { :http => "http://ios-sdk.tapdaq.com/7.8.0/cocoapods_frameworks.zip" }
  ...
  s.subspec "AdMob" do |admob|
    ...
    admob.dependency "Google-Mobile-Ads-SDK", "7.65.0"
  end
  ...
  s.subspec "AppLovin" do |applovin|
    ...
    applovin.dependency "AppLovinSDK", "6.14.2"
  end
  ...
  s.subspec "IronSource" do |ironsource|
    ...
    ironsource.dependency "IronSourceSDK", "7.0.1.0"
  end
  ...
  s.subspec "Pangle" do |pangle|
    ...
    pangle.dependency "Bytedance-UnionAD", "3.2.5.1"
  end
  ...
  s.subspec "Vungle" do |vungle|
    ...
    vungle.dependency "VungleSDK-iOS", "6.8.0"
  end
