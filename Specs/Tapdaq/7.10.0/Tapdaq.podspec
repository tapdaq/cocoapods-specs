Pod::Spec.new do |s|
  ...
  s.platform     = :ios, "10.0"
  s.source       = { :http => "https://ios-sdk.tapdaq.com/7.10.0/cocoapods_frameworks.zip" }
  ...
  s.subspec "AppLovin" do |applovin|
    ...
    applovin.dependency "AppLovinSDK", "10.3.7"
  end
  ...
  s.subspec "Chartboost" do |chartboost|
    ...
    chartboost.dependency "ChartboostSDK", "8.5.0"
  end
  ...
  s.subspec "FAN" do |fan|
    ...
    fan.dependency "FBAudienceNetwork", "6.8.0"
    fan.dependency "FBSDKCoreKit_Basics", "12.1.0"
  end
  ...
  s.subspec "InMobi" do |inmobi|
    ...
    inmobi.dependency "InMobiSDK/Core", "10.0.1"
  end
  ...
  s.subspec "IronSource" do |ironsource|
    ...
    ironsource.dependency "IronSourceSDK", "7.1.12.0"
  end
  ...
  s.subspec "Pangle" do |pangle|
    ...
    pangle.dependency "Ads-Global", "4.1.0.2"
  end
  ...
  s.subspec "Vungle" do |vungle|
    ...
    vungle.dependency "VungleSDK-iOS", "6.10.4"
  end
