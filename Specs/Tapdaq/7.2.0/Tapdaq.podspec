Pod::Spec.new do |s|
  ...
  s.subspec "AdColony" do |adcolony|
    ...
    adcolony.dependency "AdColony", "3.3.8"
  end
  ...
  s.subspec "AdMob" do |admob|
    ...
    admob.dependency "Google-Mobile-Ads-SDK", "7.44.0"
  end
  ...
  s.subspec "AppLovin" do |applovin|
    ...
    applovin.dependency "AppLovinSDK", "6.7.0"
  end
  ...
  s.subspec "Chartboost" do |chartboost|
    ...
    chartboost.dependency "ChartboostSDK", "7.5.0"
  end
  ...
  s.subspec "FAN" do |fan|
    ...
    fan.dependency "FBAudienceNetwork", "5.3.2"
  end
  ...
  s.subspec "Tapjoy" do |tapjoy|
    ...
    tapjoy.dependency "TapjoySDK", "12.3.1"
  end
  ...
  s.subspec "UnityAds" do |unityads|
    ...
    unityads.dependency "UnityAds", "3.1.0"
  end
  ...
  s.subspec "ZPlay" do |zplay|
    ...
    zplay.dependency "PlayableAds", "2.4.2"
  end
