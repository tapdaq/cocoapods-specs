Pod::Spec.new do |s|
  ...
  s.platform     = :ios, "9.0"
  s.source       = { :http => "http://ios-sdk.tapdaq.com/#{s.version}/sdk/sdk_universal_#{s.version}.zip" }
  ...
  s.subspec "AppLovin" do |applovin|
    ...
    applovin.dependency "AppLovinSDK", "6.3.0"
  end
  ...
  s.subspec "FAN" do |fan|
    ...
    fan.dependency "FBAudienceNetwork", "5.0.2"
  end
  ...
  s.subspec "HyprMx" do |hyprmx|
    ...
    hyprmx.dependency "TapdaqHyprMXSDK", "7.0.4"
  end
  ...
  s.subspec "IronSource" do |ironsource|
    ...
    ironsource.dependency "IronSourceSDK", "6.7.12"
  end
  ...
  s.subspec "YouAppi" do |youappi|
    ...
    youappi.dependency "YouAppiMoatSDK", "4.3.2"
  end
