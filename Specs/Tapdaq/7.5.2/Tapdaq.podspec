Pod::Spec.new do |s|
  ...
  s.platform     = :ios, "9.0"
  s.source       = { :http => "http://ios-sdk.tapdaq.com/7.5.2/cocoapods_frameworks.zip" }
  ...
  s.subspec "AdMob" do |admob|
    ...
    admob.dependency "Google-Mobile-Ads-SDK", "7.56.0"
  end
  ...
  s.subspec "InMobi" do |inmobi|
    ...
    inmobi.dependency "InMobiSDK", "9.0.4"
  end
  ...
  s.subspec "IronSource" do |ironsource|
    ...
    ironsource.dependency "IronSourceSDK", "6.13.0.1"
  end
  ...
  s.subspec "TikTok" do |tiktok|
    ...
    tiktok.dependency "Tapdaq-Bytedance-UnionAD", "2.7.5.2"
  end
  ...
  s.subspec "Vungle" do |vungle|
    ...
    vungle.dependency "VungleSDK-iOS", "6.5.2"
  end
